module Test.Generated.Main2735314761 exposing (main)
...
main =
    ...
    SampleTests.test_insert] ]
        |> Test.concat
        |> Test.Runner.Node.run { runs = Nothing, report = (ConsoleReport UseColor), seed = 254206792729444, processes = 8, paths = ["/home/yashas/Desktop/semester/popl/popl-assignments/hws/hw02/tests/SampleTests.elm"]}