module Test.Generated.Main41217472 exposing (main)
...
main =
    ...
    SampleTests.test_insert] ]
        |> Test.concat
        |> Test.Runner.Node.run { runs = Nothing, report = (ConsoleReport UseColor), seed = 370715678730158, processes = 8, paths = ["/home/yashas/Desktop/semester/popl/popl-assignments/hws/hw02/tests/SampleTests.elm"]}