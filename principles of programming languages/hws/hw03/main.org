...
- 3 items in the list (binop expr expr)
...
The AST has four types of nodes: num, bool, ifte and binop. The first step is to have a case expression to match the variant type.
